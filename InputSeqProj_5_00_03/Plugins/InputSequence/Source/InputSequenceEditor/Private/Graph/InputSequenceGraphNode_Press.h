...
UCLASS()
class UInputSequenceGraphNode_Press : public UInputSequenceGraphNode_Dynamic
{
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "Press node", meta = (DisplayPriority = 0))
	...
	UPROPERTY(EditAnywhere, Category = "Press node", meta = (DisplayPriority = 32))
